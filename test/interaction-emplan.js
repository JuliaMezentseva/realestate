...
(async () => {
  try {
    ...
    const goalTitle = [...w.document.querySelectorAll("div")].find(el => el.textContent.trim() === "Подписать 2 эксклюзивных договора и вывести объекты в рекламу");
    ...
    await tick(80);
    const goalCardTitle = [...w.document.querySelectorAll(".sk-title-5")].find(el => el.textContent.trim() === "Подписать 2 эксклюзивных договора и вывести объекты в рекламу");
